...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/tilemaps/testmap.csv", __ASSET__assets_tilemaps_testmap_csv);
		type.set ("assets/tilemaps/testmap.csv", AssetType.TEXT);
		className.set ("assets/tilemaps/testmap.png", __ASSET__assets_tilemaps_testmap_png);
		type.set ("assets/tilemaps/testmap.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/tilemaps/testmap.csv";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/tilemaps/testmap.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_tilemaps_testmap_csv extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_tilemaps_testmap_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:file("assets/tilemaps/testmap.csv") #if display private #end class __ASSET__assets_tilemaps_testmap_csv extends lime.utils.Bytes {}
@:image("assets/tilemaps/testmap.png") #if display private #end class __ASSET__assets_tilemaps_testmap_png extends lime.graphics.Image {}
