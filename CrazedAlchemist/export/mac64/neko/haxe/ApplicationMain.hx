...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "CrazedAlchemist", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "CrazedAlchemist";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "CrazedAlchemist", null, { width: 640, height: 480 });
...
class ApplicationMain {
	...
	public static function main () {
		...
		config = {
			...
			build: "46",
			company: "HaxeFlixel",
			file: "CrazedAlchemist",
			fps: 60,
			name: "CrazedAlchemist",
